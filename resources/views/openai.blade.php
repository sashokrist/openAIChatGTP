...
@section('content')
    ...
    <script src="https://mediafiles.botpress.cloud/081c5db5-2989-4e97-8523-8ede591726c2/webchat/config.js" defer></script>
    <div
        ...
        <div class="flex justify-between items-center mb-4">
            ...
            <div class="d-flex justify-content-end">
                <a href="{{ route('posts.index') }}" class="btn btn-primary">
                    <p style="font-size: 22px;">{{ __('All about AI') }}</p>
                </a>
            </div>
        </div>
